...
// ─── Occupied oblast administrative boundaries ───
// The four oblasts Russia claims to have annexed (Sep 2022 referendums)
// Boundary coordinates approximate the official Ukrainian administrative borders
export const OCCUPIED_OBLAST_BORDERS = [
  {
    id: 'oblast-donetsk',
    name: 'Donetsk Oblast',
    note: 'Claimed annexed by Russia Sep 2022; partially occupied',
    points: [
      // Northern border (with Kharkiv oblast)
      [36.26, 49.01], [36.45, 48.98], [36.62, 48.93], [36.80, 48.92],
      [37.00, 48.94], [37.20, 48.98], [37.38, 49.02], [37.56, 49.04],
      // Eastern border (with Luhansk oblast)
      [37.74, 49.00], [37.90, 48.90], [38.02, 48.78], [38.12, 48.64],
      [38.18, 48.50], [38.22, 48.36], [38.28, 48.20],
      // Eastern border continued (international border with Russia / Sea of Azov)
      [38.30, 48.08], [38.22, 47.94], [38.10, 47.82], [37.96, 47.72],
      [37.80, 47.62], [37.64, 47.54], [37.48, 47.48],
      // Southern coast (Sea of Azov)
      [37.30, 47.36], [37.10, 47.28], [36.90, 47.22], [36.70, 47.16],
      [36.50, 47.10], [36.30, 47.08],
      // Western border (with Zaporizhzhia oblast)
      [36.14, 47.14], [36.04, 47.24], [35.98, 47.38], [35.96, 47.52],
      [35.98, 47.66], [36.02, 47.80], [36.06, 47.94],
      // Northwestern border (with Dnipropetrovsk oblast)
      [36.08, 48.10], [36.10, 48.26], [36.12, 48.42], [36.14, 48.56],
      [36.16, 48.70], [36.20, 48.84], [36.26, 49.01],
    ],
  },
  {
    id: 'oblast-luhansk',
    name: 'Luhansk Oblast',
    note: 'Claimed annexed by Russia Sep 2022; mostly occupied',
    points: [
      // Western border (with Kharkiv oblast)
      [37.74, 49.00], [37.78, 49.14], [37.86, 49.28], [37.96, 49.42],
      [38.06, 49.54], [38.14, 49.64],
      // Northern border (with Sumy / international border)
      [38.26, 49.72], [38.44, 49.80], [38.62, 49.86], [38.82, 49.90],
      [39.04, 49.92],
      // Eastern border (international border with Russia)
      [39.24, 49.88], [39.42, 49.78], [39.56, 49.64], [39.66, 49.48],
      [39.72, 49.30], [39.74, 49.10], [39.72, 48.90], [39.66, 48.72],
      [39.56, 48.56], [39.42, 48.42],
      // Southern border (Donetsk oblast border continued)
      [39.24, 48.32], [39.04, 48.24], [38.82, 48.18], [38.60, 48.16],
      [38.40, 48.18], [38.28, 48.20],
      // Southwestern border (with Donetsk oblast)
      [38.12, 48.64], [38.02, 48.78], [37.90, 48.90], [37.74, 49.00],
    ],
  },
  {
    id: 'oblast-zaporizhzhia',
    name: 'Zaporizhzhia Oblast',
    note: 'Claimed annexed by Russia Sep 2022; partially occupied (city of Zaporizhzhia UA-held)',
    points: [
      // Northern border (with Dnipropetrovsk oblast)
      [34.40, 48.12], [34.60, 48.08], [34.82, 48.04], [35.04, 48.00],
      [35.26, 47.96], [35.48, 47.90], [35.68, 47.84], [35.88, 47.78],
      // Northeastern border (with Donetsk oblast)
      [35.98, 47.66], [35.96, 47.52], [35.98, 47.38], [36.04, 47.24],
      [36.14, 47.14],
      // Southern coast (Sea of Azov)
      [36.30, 47.08], [36.10, 47.02], [35.90, 46.96], [35.70, 46.88],
      [35.50, 46.82], [35.30, 46.76], [35.10, 46.70],
      // Southwestern coast / border
      [34.90, 46.64], [34.70, 46.60], [34.50, 46.58], [34.30, 46.60],
      [34.10, 46.66],
      // Western border (with Kherson oblast)
      [33.96, 46.74], [34.00, 46.90], [34.06, 47.06], [34.10, 47.22],
      [34.16, 47.38], [34.22, 47.54], [34.28, 47.70], [34.32, 47.86],
      [34.36, 47.98], [34.40, 48.12],
    ],
  },
  {
    id: 'oblast-kherson',
    name: 'Kherson Oblast',
    note: 'Claimed annexed by Russia Sep 2022; north bank (incl. city of Kherson) liberated Nov 2022',
    points: [
      // Northern border (with Dnipropetrovsk / Mykolaiv oblasts)
      [32.20, 47.36], [32.44, 47.32], [32.68, 47.26], [32.92, 47.20],
      [33.16, 47.14], [33.40, 47.08], [33.64, 47.02], [33.86, 46.96],
      // Northeastern border (with Zaporizhzhia oblast)
      [34.00, 46.90], [33.96, 46.74],
      // Eastern border (with Zaporizhzhia oblast, coast)
      [34.10, 46.66], [34.06, 46.50], [33.96, 46.34],
      // Southern coast (Black Sea / Crimea border at Perekop)
      [33.80, 46.22], [33.60, 46.16], [33.40, 46.12], [33.20, 46.10],
      [33.00, 46.12], [32.80, 46.16], [32.60, 46.18],
      // Southwestern coast (Dnipro estuary / Black Sea)
      [32.40, 46.22], [32.20, 46.30], [32.00, 46.40], [31.80, 46.48],
      [31.64, 46.58], [31.52, 46.70],
      // Western border (with Mykolaiv oblast)
      [31.58, 46.86], [31.68, 47.00], [31.80, 47.14], [31.94, 47.24],
      [32.08, 47.32], [32.20, 47.36],
    ],
  },
];
