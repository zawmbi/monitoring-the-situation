...
export const CONFLICT_SUMMARY = {
  ...
  phase: 'Ground operations / Ceasefire negotiations',
...
export const CASUALTIES = {
  sideA: {
    killed: { low: 800, high: 900, label: '~850' },
    wounded: { low: 5000, high: 6000, label: '5,000–6,000' },
    civilian: { killed: 1200, label: '~1,200 (Oct 7 attack)' },
    hostages: { taken: 251, released: 150, remaining: 101, label: '~101 remaining (est. ~60 alive)' },
    source: 'IDF / Israeli MoD',
  },
  sideB: {
    killed: { low: 17000, high: 20000, label: '17,000–20,000 militants (IDF est.)' },
    wounded: { low: 25000, high: 35000, label: '25,000–35,000' },
    captured: { low: 5000, high: 8000, label: '5,000–8,000' },
    source: 'IDF claims / OSINT est.',
  },
  civilian: {
    gazaKilled: { low: 45000, high: 47000, label: '~46,000+ (Gaza MoH)' },
    gazaWounded: { low: 90000, high: 110000, label: '~100,000+ (Gaza MoH)' },
    note: 'Gaza MoH figures include combatants; distinction contested. UN considers figures broadly credible.',
    source: 'Gaza Ministry of Health / OCHA / Lancet',
  },
  asOf: 'February 2026',
};
...
export const COMMAND = {
  sideA: {
    ...
    commanderInChief: { name: 'Herzi Halevi', role: 'Chief of General Staff', since: 'Jan 2023' },
    keyCommanders: [
      { name: 'Benjamin Netanyahu', role: 'Prime Minister / Defense Council Chair' },
      { name: 'Yoav Gallant (until Nov 2024)', role: 'Minister of Defense (dismissed)' },
      { name: 'Israel Katz', role: 'Minister of Defense (from Nov 2024)' },
      { name: 'Herzi Halevi', role: 'Chief of General Staff' },
  ...
  sideB: {
    ...
    keyCommanders: [
      { name: 'Yahya Sinwar (killed)', role: 'Former Hamas Leader in Gaza — killed Oct 2024' },
      { name: 'Mohammed Deif (killed)', role: 'Former Al-Qassam Commander — killed Jul 2024' },
      { name: 'Mohammed Sinwar', role: 'Hamas Leader (brother of Yahya)' },
      { name: 'Khalil al-Hayya', role: 'Hamas Political Bureau Deputy (Qatar)' },
      { name: 'Marwan Issa (killed)', role: 'Former Deputy Al-Qassam Commander — killed Mar 2024' },
    ],
    totalPersonnel: '~30,000 pre-war (est. 50-60% degraded)',
  },
};

// ─── Timeline ───
export const WAR_TIMELINE = [
  { date: '2023-10-07', event: 'Hamas launches surprise attack on southern Israel; 1,200 killed, 250 hostages', phase: 'invasion' },
  ...
  { date: '2023-10-17', event: 'Al-Ahli Hospital explosion — 471 killed; blame disputed', phase: 'invasion' },
  { date: '2023-10-27', event: 'IDF ground incursion into northern Gaza begins', phase: 'ground' },
  { date: '2023-11-15', event: 'IDF raids Al-Shifa Hospital; claims Hamas command center', phase: 'ground' },
  { date: '2023-11-24', event: 'First hostage deal: 7-day pause, 105 hostages released for 240 prisoners', phase: 'ceasefire' },
  { date: '2023-12-01', event: 'Fighting resumes after ceasefire expires; IDF pushes into south', phase: 'ground' },
  { date: '2024-01-15', event: 'ICJ orders Israel to prevent genocide; stops short of ceasefire order', phase: 'legal' },
  { date: '2024-03-25', event: 'UN Security Council passes ceasefire resolution (US abstains)', phase: 'legal' },
  { date: '2024-05-06', event: 'IDF launches Rafah ground operation despite US opposition', phase: 'ground' },
  { date: '2024-05-24', event: 'ICJ orders Israel to halt Rafah offensive', phase: 'legal' },
  { date: '2024-07-13', event: 'IDF strike targeting Mohammed Deif in Khan Yunis; ~90 killed', phase: 'ground' },
  { date: '2024-08-01', event: 'Hamas leader Ismail Haniyeh assassinated in Tehran', phase: 'escalation' },
  { date: '2024-10-16', event: 'Yahya Sinwar killed by IDF in Rafah', phase: 'ground' },
  { date: '2024-11-27', event: 'Israel-Lebanon ceasefire agreement reached', phase: 'ceasefire' },
  { date: '2025-01-15', event: 'Gaza ceasefire framework agreed; phased hostage release begins', phase: 'ceasefire' },
  { date: '2025-03-01', event: 'Phase 1 ceasefire holds; 33 hostages released', phase: 'ceasefire' },
  { date: '2025-06-01', event: 'Ceasefire collapses; IDF resumes operations in northern Gaza', phase: 'ground' },
  { date: '2025-09-01', event: 'ICC issues arrest warrants for Netanyahu and Hamas leaders', phase: 'legal' },
  { date: '2025-12-01', event: 'UN reports 80%+ of Gaza structures damaged or destroyed', phase: 'ground' },
  { date: '2026-01-15', event: 'Second ceasefire framework under negotiation; partial hostage deal', phase: 'ceasefire' },
];
...
export const HUMANITARIAN = {
  ...
  infrastructureDamage: {
    ...
    economicDamage: '$18.5 billion (World Bank est.)',
    reconstructionCost: '$80 billion+ (UN est.)',
    source: 'World Bank / UNDP / OCHA',
  },
  aidAccess: {
    status: 'Severely restricted',
    trucksPerDay: '~50 (vs 500 pre-war)',
    note: 'Famine conditions in northern Gaza; aid delivery repeatedly blocked',
    source: 'OCHA / WFP',
  },
  asOf: 'February 2026',
};
...
export const INTERNATIONAL_RESPONSE = {
  icjRuling: 'Ordered Israel to prevent genocide and allow aid (Jan 2024)',
  iccWarrants: 'Arrest warrants for Netanyahu, Gallant, and Hamas leaders (2025)',
  unResolutions: 'Multiple UNGA resolutions demanding ceasefire; UNSC ceasefire resolution Mar 2024',
  armsEmbargoes: 'Several countries suspended arms sales (Belgium, Italy, Spain, Netherlands, Canada)',
  usAid: '$14.1 billion emergency military aid (Oct 2023), $26B+ total since Oct 7',
  recognitions: 'Norway, Ireland, Spain, Slovenia recognized Palestine statehood (2024)',
  asOf: 'February 2026',
};
