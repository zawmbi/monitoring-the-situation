...
export const BATTLE_SITES = [
  {
    ...
    significance: 'One of the deadliest conflicts of the 21st century. Massive civilian casualties. Pretoria Agreement (Nov 3, 2022) ended active fighting.',
  },
  {
  ...
  },
  {
    ...
    note: 'OLA guerrilla war in Oromia region; civilian targeting by both sides',
...
export const COMMAND = {
  ...
  sideB: {
    ...
    keyCommanders: [
      { name: 'Debretsion Gebremichael', role: 'TPLF Chairman (Tigray - ceasefire)' },
      { name: 'Various Fano commanders', role: 'Amhara militia (decentralized)' },
...
export const WAR_TIMELINE = [
  ...
  { date: '2023-08-04', event: 'Fano insurgency erupts in Amhara after disarmament attempt', phase: 'amhara' },
...
export const HUMANITARIAN = {
  ...
  hunger: {
    atRisk: 20000000,
    label: '~20 million food insecure',
    source: 'WFP / IPC',
  },
  tigrayRecovery: {
