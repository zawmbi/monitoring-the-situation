 ...
 * Cards link directly to Polymarket/Kalshi — clicking redirects to the source.
 * Data from both Polymarket and Kalshi (free, public APIs).
...
function MarketCard({ market }) {
  return (
    ...
    >
      ...
      <div className="im-question">
        {market.question || 'Untitled Market'}
        <svg className="im-external" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    <div className="im-container">
      ...
      >
        <div className="im-header-left">
          ...
          {(count > 0 || loading) && <span className="im-live-dot" title="Live — updates every 90s" />}
        </div>
